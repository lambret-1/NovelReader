...
struct ReaderTheme: Equatable {
    ...
    static let day = ReaderTheme(
        id: "day",
        name: "日间",
        backgroundColor: UIColor(red: 0.98, green: 0.98, blue: 0.96, alpha: 1.0),
        textColor: UIColor(red: 0.15, green: 0.15, blue: 0.15, alpha: 1.0),
    ...
    static let eyeCare = ReaderTheme(
        id: "eye_care",
        name: "护眼",
        backgroundColor: UIColor(red: 0.76, green: 0.84, blue: 0.68, alpha: 1.0),
        textColor: UIColor(red: 0.18, green: 0.25, blue: 0.15, alpha: 1.0),
    ...
    static let sepia = ReaderTheme(
        id: "sepia",
        name: "羊皮纸",
        backgroundColor: UIColor(red: 0.92, green: 0.87, blue: 0.78, alpha: 1.0),
        textColor: UIColor(red: 0.25, green: 0.20, blue: 0.15, alpha: 1.0),
